...
class instruction:
	...
	register: str = ''									# Return address.
	args: tuple[str, ...] = ()							# Argument addresses.
	line: int = 0										# Position in the code file.
	...
	def __str__(self) -> str:
		...
		return '{0} {1} {2} {3}; {4}'.format(self.line, self.name, self.register, ' '.join(self.args), ' '.join(self.label))
